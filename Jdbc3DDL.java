...
public class Jdbc3DDL {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		/*her sorguda oncekileri yoruma al hata vermesin
		   A) CREATE TABLE, DROP TABLE, ALTER TABLE gibi DDL ifadeleri icin sonuc kÃ¼mesi (ResultSet) 
		      dondurmeyen metotlar kullanilmalidir.(executeQuery kullanamayÄ±z) Bunun icin JDBC'de 2 alternatif bulunmaktadir.  
		       1) execute() metodu 
		   ...
		   C) - executeUpdate() metodu ise INSERT, Update gibi DML islemlerinde yaygin kullanilir.
		      ...
		      - AyrÄ±ca, DDL islemlerinde de kullanilabilir ve bu islemlerde 0 dondurur.
		*/
...
//		System.out.println("olanlar oldu");
//	System.out.println("=========================================");
...
//		//	System.out.println("=========================================");
		...
		//ORNEK5: isciler tablosunun adini calisanlar olarak degistirin
