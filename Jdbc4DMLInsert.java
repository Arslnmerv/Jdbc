...
//		st.executeUpdate("DROP TABLE bolumler PURGE");
...
//		 System.out.println("islem tamam");
		/*
		 * ORNEK2: Bolumler tablosuna birden fazla yeni kayıt ekleyelim. 1.YONTEM
		 * ----------------------------------------------- Ayri ayri sorgular ile
		 * veritabanina tekrar tekrar ulasmak islemlerin yavas yapilmasina yol acar.
